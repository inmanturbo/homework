                    ...
                    >
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center group-hover:bg-blue-200 dark:group-hover:bg-blue-800 transition duration-200 overflow-hidden">
                                    @if(!empty($org['logo_url']))
                                        <img src="{{ $org['logo_url'] }}" alt="{{ $org['name'] }}" class="w-10 h-10 object-cover">
                                    @else
